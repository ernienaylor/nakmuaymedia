    ...
    <footer className="bg-secondary text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Column 1: About */}
          <div>
            <h3 className="text-lg font-bold mb-4">Nak Muay Media</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/news" className="text-white/70 hover:text-primary transition-colors">
                  News
                </Link>
              </li>
              <li>
                <Link href="/events" className="text-white/70 hover:text-primary transition-colors">
                  Events
                </Link>
              </li>
              <li>
                <Link href="/fighters" className="text-white/70 hover:text-primary transition-colors">
                  Fighters
                </Link>
              </li>
              <li>
                <Link href="/videos" className="text-white/70 hover:text-primary transition-colors">
                  Videos
                </Link>
              </li>
              <li>
                <Link href="/podcast" className="text-white/70 hover:text-primary transition-colors">
                  Podcast
                </Link>
              </li>
              <li>
                <Link href="/shop" className="text-white/70 hover:text-primary transition-colors">
                  Shop
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-white/70 mb-4">
              Subscribe to our newsletter for the latest Muay Thai news and updates.
            </p>
            <form className="space-y-2">
              <input
                type="email"
                placeholder="Your email address"
                className="w-full px-4 py-2 rounded bg-secondary-light text-white border border-white/20 focus:outline-none focus:border-primary"
                required
              />
              <button
                type="submit"
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center md:text-left">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/70">
              &copy; {currentYear} Nak Muay Media. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0">
              <Link href="/privacy" className="text-white/70 hover:text-primary transition-colors mr-6">
                Privacy
              </Link>
              <Link href="/terms" className="text-white/70 hover:text-primary transition-colors">
                Terms
