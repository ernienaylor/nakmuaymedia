          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="mt-1 text-neutral-600">info@nakmuaymedia.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="mt-1 text-neutral-600">+1 (123) 456-7890</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="mt-1 text-neutral-600">123 Muay Thai Street, Bangkok, Thailand</p>
              </div>
            </div>
          </div>
